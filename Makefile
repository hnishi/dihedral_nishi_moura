...
CXX = g++ # compiler
CXXFLAGS =  -Wall -g -O2 -pipe -I ~/Dropbox/software/eigen-eigen-1306d75b4a21  # -DEIGEN_NO_DEBUG  # compiler option, -Wall enables strict warnings # -std=c++0x -std=c++11
TARGET = a.out # the name of the program you want to make
SRCS = dihedralnishi.cpp main.cpp pdbnishi.cpp tranishi.cpp centnishi.cpp inpnishi.cpp math_nishi.cpp# the names of all source files
